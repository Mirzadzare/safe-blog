  ...
  return (
    <footer className="bg-gray-900 text-gray-400 border-t border-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-sm">
          ...
          <div className="col-span-2">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-lg font-bold text-white">SafeBlog</span>
            </div>
            <p className="text-xs leading-relaxed max-w-xs">
              Secure platform for sharing your learning journey.
            </p>
          </div>
        ...
        {/* Bottom Bar */}
        <div className="mt-8 pt-6 border-t border-gray-800 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs">
          <p>© {currentYear} SafeBlog. All rights reserved.</p>
          <div className="flex gap-5">
            ...
            <a href="#" className="hover:text-green-500 transition-colors" aria-label="GitHub">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
